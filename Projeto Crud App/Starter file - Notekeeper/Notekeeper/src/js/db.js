 ...
 * Import module
 */
import { generateID, findNotebook, findNotebookIndex, findNote, 
...
const initDB = function () {
    const /** {JSON | undefined} */ db = localStorage.getItem
    ('notekeeperDB');
...
export const db = {
    ...
    get: {
         ...
         * @returns {Array<Object>} An array of the note objects.
         */
        note(notebookId) {
            readDB();
    ...
    update : {
         ...
         * 
         * @function
         * @param {string} noteId - The ID of the notebook to update.
         * @param {string} object - The new name for the note.
         * @returns {Object} The updated notebook object.
         */
        note(noteId, object) {
            readDB();
    ...
    delete: {
        ...
        note(notebookId, noteId) {
            ...
            const /** {Object} */ notebook = findNotebook(notekeeperDB, 
                notebookId);
            const /** {number} */ noteIndex = findNoteIndex(notebook, 
                noteId);
