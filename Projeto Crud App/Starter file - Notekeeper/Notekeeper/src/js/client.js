 ...
 * 
 * @param {boolean} isThereAnyNotebook - Indicates wheter there are any notebooks.
 */
...
export const client = {
    ...
    * Creates a new notebook in the UI, based on provided notebook data.
     ...
     */
        ...
        /**
         * Reads and displays a list of notebooks in the UI, based UI.
         * 
    ...
    note: {
        ...
        create(noteData) {
            ...
            if (!$notePanel.querySelector('[data-note]')) $notePanel.
            innerHTML = '';
