...
/**
 * Show a notebook creating field in the sidebar when the "Add Notebook" button is clicked.
 ...
 * The new notebook is stored is the database.
 * 
...
/**
 * Render the existing notebook list by retrieving data from the database and passaging it to the client.
 */
